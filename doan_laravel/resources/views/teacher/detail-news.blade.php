   ...
   <div class="row">
       ...
       <div class="col-3">
           <div class="box-submit">
            <div class="d-flex bd-highlight mb-3 ">
                <div class="me-auto p-2 bd-highlight" style="font-size:25px">Số lượng đã nộp</div>
                <div class="p-2 bd-highlight text-center mt-2">76</div>
             
              </div>
              <p class="text-center">tep dinh kem</p>
              <button type="button" class="btn btn-light w-100" style="border: 1px solid #ddd;color:rgb(189, 47, 47)">Thu bài</button>
